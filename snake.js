...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'snake.data';
      var REMOTE_PACKAGE_BASE = 'snake.data';
...
var REMOTE_PACKAGE_SIZE = metadata['remote_package_size'];
    ...
    function runWithFS() {
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_snake.data');

      };
      Module['addRunDependency']('datafile_snake.data');
    ...
    loadPackage({"files": [{"filename": "/JetBrainsMono-Light.ttf", "start": 0, "end": 276452}], "remote_package_size": 276452});
...
var ASM_CONSTS = {
 ...
 347152: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 347235: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 347304: () => { return window.innerWidth; },  
 347334: () => { return window.innerHeight; }
};
